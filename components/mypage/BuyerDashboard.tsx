                         ...
                         return (
                           <div className="flex flex-wrap gap-1 mb-1">
                             <button
                               ...
                               className="inline-flex items-center gap-1 text-[11px] font-black text-indigo-500 hover:text-indigo-700 bg-indigo-50 hover:bg-indigo-100 px-3 py-1 rounded-full transition-all"
                             >
                               💳 결제정보 확인
                             </button>
                             {receiptUrl && (
                               <a
                                 ...
                                 className="inline-flex items-center gap-1 text-[11px] font-black text-blue-500 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 px-3 py-1 rounded-full transition-all"
                               >
                                 🧾 카드영수증 보기
                               </a>
                             )}
