...
const LiveNotification: React.FC = () => {
  ...
  return (
    <div className="fixed top-24 right-8 z-[100] notification-fade">
      <div className="bg-white/95 backdrop-blur-md border border-gray-100 shadow-xl rounded-2xl p-5 flex items-center gap-4 min-w-[340px]">
        <div className="flex-shrink-0 flex items-center justify-center w-6 h-6">
          <div className={`w-2.5 h-2.5 rounded-full shadow-sm animate-pulse ${notification.type === 'order' ? 'bg-blue-500 shadow-blue-200' : 'bg-red-500 shadow-red-200'}`}></div>
        </div>
