...
const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-amber-50 flex items-center justify-center ring-4 ring-amber-100/80">
          <span className="text-3xl" aria-hidden>⚠️</span>
        </div>
        <h3
          id="confirm-modal-title"
          className="text-xl font-black text-gray-900 uppercase tracking-tight border-b-2 border-red-500 pb-1 inline-block mb-4"
        >
          {title}
        </h3>
        <p className="text-gray-700 font-bold text-[15px] leading-relaxed mb-1">
          {description}
        </p>
        {dangerLine && (
