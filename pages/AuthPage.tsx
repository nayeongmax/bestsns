  ...
  return (
    <div className={`flex items-center justify-center p-5 font-['Noto_Sans_KR',sans-serif] ${onClose ? '' : 'min-h-screen bg-slate-100'}`}>
      <div className="w-full max-w-[920px] max-md:max-w-[440px] h-[780px] max-md:h-[720px] bg-white rounded-[28px] shadow-[0_30px_80px_rgba(0,0,0,0.12),0_8px_32px_rgba(0,0,0,0.07)] flex overflow-hidden auth-card-enter relative flex-shrink-0">
        ...
        <div className="flex-1 flex flex-col min-h-0 p-5 sm:p-8 md:p-12 xl:p-12 overflow-y-auto">
          {isFormMode && (
            <div className="flex items-center justify-center mb-6 xl:mb-8">
              <div ref={toggleTrackRef} className="inline-flex bg-[#f1f5f9] rounded-full p-1 border border-[#e2e8f0] w-[200px] sm:w-[220px] xl:w-[220px] relative">
          ...
          {mode === 'LOGIN' && (
            <div className="flex flex-col justify-center min-h-0 py-1">
              <h3 className="font-['Plus_Jakarta_Sans',sans-serif] text-[22px] sm:text-[25px] xl:text-[25px] font-extrabold text-[#0f172a] tracking-tight text-center mb-3">로그인</h3>
              <form onSubmit={handleLogin} className="space-y-2.5">
                <div className="relative flex items-center">
                  <span className="absolute left-3.5 text-[#94a3b8] pointer-events-none"><IconUser /></span>
                  <input type="text" placeholder="아이디 또는 이메일" value={formData.id} onChange={e => setFormData({ ...formData, id: e.target.value })} className="w-full pl-10 pr-4 py-3.5 sm:py-4 xl:py-4 bg-[#f8faff] border border-[#e2e8f0] rounded-xl text-[#0f172a] text-[15px] sm:text-sm xl:text-sm outline-none focus:border-[#2563EB] focus:bg-white focus:ring-[3px] focus:ring-[#2563eb1a] transition-all" required />
                </div>
                <div className="relative flex items-center">
                  <span className="absolute left-3.5 text-[#94a3b8] pointer-events-none"><IconLock /></span>
                  <input type={showPwLogin ? 'text' : 'password'} placeholder="비밀번호" value={formData.pw} onChange={e => setFormData({ ...formData, pw: e.target.value })} className="w-full pl-10 pr-10 py-3.5 sm:py-4 xl:py-4 bg-[#f8faff] border border-[#e2e8f0] rounded-xl text-[#0f172a] text-[15px] sm:text-sm xl:text-sm outline-none focus:border-[#2563EB] focus:bg-white focus:ring-[3px] focus:ring-[#2563eb1a] transition-all" required />
          ...
          {mode === 'JOIN' && (
            <div className="flex flex-col justify-center min-h-0 py-1">
              ...
              <form onSubmit={handleJoin} className="space-y-2.5">
                ...
                <div className="relative flex items-center"><span className="absolute left-3.5 text-[#94a3b8]"><IconUser /></span><input type="text" placeholder="이름" value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} className="w-full pl-10 pr-4 py-3 sm:py-3 xl:py-3 bg-[#f8faff] border border-[#e2e8f0] rounded-xl text-[#0f172a] text-[15px] sm:text-sm xl:text-sm outline-none focus:border-[#2563EB] focus:bg-white focus:ring-[3px] focus:ring-[#2563eb1a] transition-all" /></div>
                <div className="relative flex items-center"><span className="absolute left-3.5 text-[#94a3b8]"><IconPhone /></span><input type="tel" placeholder="휴대폰 번호 (010-0000-0000)" value={formData.phone} onChange={e => setFormData({ ...formData, phone: e.target.value })} className="w-full pl-10 pr-4 py-3 sm:py-3 xl:py-3 bg-[#f8faff] border border-[#e2e8f0] rounded-xl text-[#0f172a] text-[15px] sm:text-sm xl:text-sm outline-none focus:border-[#2563EB] focus:bg-white focus:ring-[3px] focus:ring-[#2563eb1a] transition-all" /></div>
                <div className="relative flex items-center"><span className="absolute left-3.5 text-[#94a3b8]"><IconEmail /></span><input type="email" placeholder="이메일" value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} className="w-full pl-10 pr-4 py-3 sm:py-3 xl:py-3 bg-[#f8faff] border border-[#e2e8f0] rounded-xl text-[#0f172a] text-[15px] sm:text-sm xl:text-sm outline-none focus:border-[#2563EB] focus:bg-white focus:ring-[3px] focus:ring-[#2563eb1a] transition-all" required /></div>
