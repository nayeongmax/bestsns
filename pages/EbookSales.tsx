                    ...
                    <tbody className="divide-y divide-gray-100">
                       ...
                       <tr className="flex flex-col md:table-row">
                          ...
                          <td className="px-6 py-4 font-medium text-gray-900 border-b md:border-b-0">
                             <p className="mb-1 whitespace-nowrap">파일형태: 마이페이지 자동 발송</p>
                             <p className="whitespace-nowrap">용역형태: 전문가 개별 협의</p>
                          </td>
                          <td className="bg-gray-50/80 px-6 py-4 font-bold text-gray-600 text-[13px] uppercase tracking-wide">시스템사양</td>
                          <td className="px-6 py-4 font-medium text-gray-900"><span className="whitespace-nowrap">파일 호환 가능 환경</span></td>
                       </tr>
                       <tr className="flex flex-col md:table-row">
