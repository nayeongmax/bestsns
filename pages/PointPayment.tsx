          ...
          <div className="flex-1 bg-white p-10 rounded-[48px] shadow-2xl space-y-12 lg:sticky lg:top-24 border border-gray-50">
            ...
            {!isProductPayment && (
              <div className="pt-2 space-y-1">
                ...
                <p className="text-[11px] text-red-400 font-bold leading-relaxed">(단, 지급된 크레딧을 사용하실 경우에는 환불이 불가능하오니 이점 유의하여 주시기 바랍니다.)</p>
                <p className="text-[11px] text-red-500 font-bold leading-relaxed">크레딧 구매 후 1C도 사용하지 않았을 때 환불이 가능합니다.</p>
