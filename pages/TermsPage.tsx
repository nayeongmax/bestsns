      ...
      <div className="bg-white rounded-[48px] p-10 md:p-14 shadow-sm border border-gray-100 space-y-8 text-gray-700">
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 pl-2">
              <li className="text-red-600">1. 환불은 결제 완료 후 48시간 이내에만 가능합니다.<br />(단, 지급된 크레딧을 사용하실 경우에는 환불이 불가능하오니 이점 유의하여 주시기 바랍니다.)</li>
              <li>2. 크레딧 구매 후 1C도 사용하지 않았을 때 환불이 가능합니다.</li>
