        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-3 pl-2">
              <li>1. 포인트를 전혀 사용하지 않은 경우 전액 환불이 가능합니다. (환불 수수료 없음)</li>
              <li>2. 포인트를 일부 사용한 경우에는 포인트 구매 후 14일 이내에 한해 전액 환불이 가능합니다.</li>
              <li>3. 포인트 구매 후 14일이 경과한 경우에는 환불이 불가합니다.</li>
              <li>4. 아래에 해당하는 경우 포인트는 환불이 불가합니다.
              ...
              <li>5. 환불 신청은 고객센터를 통해 접수하며, 신청 접수 후 10일 이내에 처리됩니다.</li>
            </ul>
          </div>
