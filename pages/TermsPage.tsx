        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 pl-2">
              <li>1. THEBESTSNS란 더베스트[THEBEST]가 운영하는 온라인 플랫폼으로서 회원이 온라인 마케팅 서비스, 마케팅주문 서비스, 채널 거래, 디지털 콘텐츠 판매 및 작업 매칭 서비스를 이용할 수 있도록 제공되는 전자적 시스템을 의미한다.</li>
              ...
              <li>5. 서비스란 플랫폼을 통해 제공되는 마케팅주문 서비스, 채널 거래 서비스, 디지털 콘텐츠 판매 서비스, 작업 매칭 서비스 등 회사가 제공하는 모든 기능을 의미한다.</li>
            </ul>
          </div>
