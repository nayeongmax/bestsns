        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 pl-2">
              ...
              <li>4. 크레딧 또는 충전 크레딧이란 회원이 플랫폼에서 서비스 이용을 위해 충전하거나 지급받은 예치성 금액을 의미하며 1크레딧은 1원과 동일한 가치를 가진다.</li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-3 pl-2">
              <li><strong>디지털 마케팅 서비스</strong>
                <p className="mt-1 text-sm text-gray-600">마케팅 상품 주문 즉시 작업이 시작됩니다. 이후에는 취소·환불이 불가합니다.</p>
              </li>
              <li><strong>채널 거래 서비스</strong>
                <p className="mt-1 text-sm text-gray-600">채널 양도를 받을 계정은 정확하게 입력하여야 하며 오입력으로 인한 환불은 불가하다. 유튜브 정책상 채널 양도에는 7일이 소요된다. 채널 인도 이후 최소 10일 동안 채널 운영 및 작업을 진행하지 않을 것을 권장한다. 채널 인수 이후 해킹 또는 계정 및 채널 문제는 회원의 과실로 판단된다.</p>
              </li>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 pl-2">
              ...
              <li>3. 채널 양도를 받을 계정은 구매 시 정확하게 입력하여야 한다. 오타 또는 계정 오입력으로 인한 문제는 플랫폼의 책임이 아니며 환불되지 않는다.</li>
              <li>4. 유튜브 정책상 채널 양도 기간인 7일이 경과하여야 양도가 완료된다.</li>
              <li>5. 채널 인도 후 최소 10일 동안 채널 운영 및 작업을 진행하지 않는 것을 권장하며, 이를 준수하지 않아 발생하는 문제에 대해 회사는 책임을 지지 않는다.</li>
              <li>6. 채널 인도 후 초반부터 유튜브 정책에 위반되는 과도한 매크로 작업, 선정적·위법적 콘텐츠 업로드 등의 행위는 금지되며, 이로 인한 채널 제재 및 이용 불가에 대해 회사는 책임을 지지 않는다.</li>
              <li>7. 채널 인수 이후 해킹, 계정 탈취, 또는 회원의 부주의로 인한 계정 및 채널 문제는 회원의 과실로 판단되며 회사는 이에 대한 책임을 지지 않는다.</li>
            </ul>
          </div>
          ...
          {/* 13조 */}
          <div>
            <p className="font-black text-gray-900 text-lg">제13조 (예치금 [크레딧])</p>
            <ul className="mt-2 space-y-2 pl-2">
              <li>1. 회원은 사이트에 예치금(1크레딧 = 1원)을 충전함으로써 'BESTSNS'의 모든 서비스를 기재된 가격으로 이용할 수 있습니다.</li>
              <li>2. 무상으로 적립된 크레딧을 통해 서비스를 구매한 경우, 현금영수증 또는 세금계산서가 발행되지 않습니다.</li>
              <li>3. 무상으로 지급받은 크레딧은 유상으로 충전한 크레딧(실제로 회원이 입금한 금액)을 모두 소진한 이후부터 사용되어집니다.</li>
              <li>4. 회원이 부당 또는 부정하게 크레딧을 취득한 경우 회원은 해당 잔액을 사용할 수 없으며 회사는 이를 회수할 수 있습니다.</li>
              <li>5. 충전된 예치금의 유효기간은 회원이 마지막 로그인한 날로부터 1년입니다. 해당 기간이 지날 경우 회사는 회원이 충전된 크레딧에 대한 권리를 포기하는 것으로 간주합니다. 회원은 소멸된 금액을 재청구 할 수 없습니다.</li>
              <li>6. 회사는 크레딧이 있는 회원에게 마지막 로그인으로부터 30일 간격으로 소멸 예정 사실을 이메일, 문자 메시지 혹은 카카오톡 알림톡으로 통지하며 소멸된 크레딧은 회사에 귀속됩니다.</li>
            </ul>
          </div>

          {/* 14조 */}
          <div>
            <p className="font-black text-gray-900 text-lg">제14조 (크레딧 환불)</p>
            <ul className="mt-2 space-y-2 pl-2">
              <li>1. 충전한 크레딧을 전혀 사용하지 않은 경우, 수수료 없이 전액 환불이 가능합니다.</li>
              <li>2. 조금이라도 크레딧을 사용하면 환불이 불가합니다.</li>
              <li>3. 충전일로부터 14일이 경과한 이후에는 환불이 불가합니다.</li>
              <li>4. 다음에 해당하는 크레딧은 환불이 불가합니다.
                <ul className="mt-1 pl-4 space-y-1 text-sm text-gray-600">
                  <li>가. 이벤트 등으로 무상 지급된 크레딧</li>
                  <li>나. 회원이 직접 충전하지 않은 비충전 크레딧</li>
                </ul>
              </li>
              <li>5. 환불은 입금 원금 기준으로만 가능하며, 무상 지급 크레딧은 환불 대상에서 제외됩니다.</li>
              <li>6. 환불 신청은 고객센터 상담채팅방을 통해 접수하시면 됩니다.</li>
            </ul>
          </div>
