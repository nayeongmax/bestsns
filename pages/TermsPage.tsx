        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-3 pl-2">
              ...
              <li>2. 포인트를 전혀 사용하지 않은 경우 전액 환불이 가능합니다. (환불 수수료 없음)</li>
              <li>3. 포인트를 일부 사용한 경우에는 포인트 구매 후 14일 이내에 한해 전액 환불이 가능합니다.</li>
              <li>4. 포인트 구매 후 14일이 경과한 경우에는 환불이 불가합니다.</li>
              <li className="font-bold text-gray-900">5. 환불의 경우 결제 수단이 아닌 다른 방식의 환불은 불가하고 결제 수단으로의 취소만 가능합니다. 환불 가능한 기간은 결제 일로부터 1년 이상 경과할 수 없습니다.</li>
              <li>6. 아래에 해당하는 경우 포인트는 환불이 불가합니다.
                <ul className="mt-1 pl-4 space-y-1 text-sm text-gray-600">
                  <li>1) 타인에게 양도된 포인트</li>
                  <li>2) 이벤트 등으로 무상 지급된 포인트</li>
