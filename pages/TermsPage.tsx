        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 pl-2">
              ...
              <li>2. 크레딧 일부를 사용한 경우 환불이 불가합니다.</li>
              <li>3. 충전일로부터 14일이 경과한 이후에는 환불이 불가합니다.</li>
              <li>4. 이벤트 등으로 무상 지급된 크레딧, 회원이 직접 충전하지 않은 크레딧은 환불이 불가합니다.</li>
              <li>5. 환불 신청은 고객센터 상담채팅방을 통해 접수바랍니다.</li>
              <li>6. 계좌번호 오타로 입금실수 시 적립 및 환불이 불가하니 확인하고 입금주세요.</li>
            </ul>
          </div>
