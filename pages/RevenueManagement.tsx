      ...
      <div className="lg:col-span-4 space-y-4 sm:space-y-6">
        <div className="bg-gray-900 rounded-xl sm:rounded-3xl md:rounded-[40px] p-4 sm:p-8 md:p-10 shadow-2xl border border-gray-800 space-y-4 sm:space-y-8 text-white relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-6 pt-2 sm:pt-4">
            ...
            <div className="bg-white/5 p-3 sm:p-6 rounded-xl sm:rounded-3xl border border-white/10 min-w-0 overflow-hidden">
               <span className="text-[8px] sm:text-[10px] font-bold text-gray-400 uppercase">총 매출액</span>
               <p className="text-sm sm:text-xl font-black mt-0.5 sm:mt-1 italic tracking-tighter whitespace-nowrap">₩{totalIncome.toLocaleString()}</p>
            </div>
          </div>
    ...
    <div className="space-y-4 sm:space-y-10 animate-in fade-in duration-500 max-w-[1600px] mx-auto">
      <div className="bg-white rounded-xl sm:rounded-3xl md:rounded-[60px] p-3 sm:p-6 md:p-10 lg:p-16 shadow-sm border border-gray-100">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 mb-6 sm:mb-12">
           ...
           <div className="bg-gray-900 rounded-2xl sm:rounded-[32px] p-4 sm:p-8 flex flex-col gap-1 sm:gap-2 min-w-0 overflow-hidden">
             <span className="text-[9px] sm:text-[10px] font-black text-gray-400 uppercase tracking-widest">총합 결제금</span>
             <span className="text-lg sm:text-2xl font-black text-white italic whitespace-nowrap">₩{totalIncome.toLocaleString()}</span>
             <span className="text-[9px] sm:text-[10px] font-bold text-green-400 whitespace-nowrap">정산금 ₩{totalProfit.toLocaleString()}</span>
           </div>
